...
function todosIguales(arreglo) {
  ...
  //Escribe tu código aquí  
  var elementoIgual = 0;
  elementoIgual = arreglo[0];

  for (var i = 1; i<arreglo.length ;i++){

    if (arreglo[i] != elementoIgual ){
...
function mesesDelAño(array) {
  ...
  // Tu código:
  const mesesGuardados = []; //guardan los meses

  for (let i =0; i< array.length; i++){ // for para recorrer los elementos del array
